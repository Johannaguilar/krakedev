...
validarNombre=function(nombre){
    ...
    if(nombre==""){
        erroresNombre=true;
        mostrarTexto("txtErrorNombre","DEBE CONTENER UN NOMBRE EN MAYUSCULAS");
    }
    if(erroresNombre==true){
        mostrarTexto("txtErrorNombre","DEBE CONTENER UN NOMBRE EN MAYUSCULAS");
    }
    if(erroresNombre==false){
        mostrarTexto("txtErrorNombre","");
    }
...
validarSueldo=function(sueldo){
    ...
    if(erroresSueldo==true){
        mostrarTexto("txtErrorEdad","DEBE SER UN NUMERO ENTERO ENTRE 0 Y 100");
    }
    if(erroresSueldo==false){
        mostrarTexto("txtErrorEdad","");
    }
